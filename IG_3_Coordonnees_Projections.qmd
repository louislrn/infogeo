...
<img src="figs/globe.gif" width="420" />
<br>
<br>
...
<p style="text-align:center;">**Un système géodésique permet de localiser un objet sur une surface en 3 dimensions**</p>
...
knitr::include_graphics('figs/mercator.jpg')
```
...
knitr::include_graphics('figs/gall_peters.jpg')
```
...
::: column
```{r, echo = FALSE, out.width = "550px", fig.align='center'}
knitr::include_graphics('figs/Natural_Earth.JPG')
```
...
knitr::include_graphics('figs/postel.png')
```
